<header class="bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-800 w-full z-20 top-0 left-0 shadow">
    <div class="flex flex-wrap items-center justify-between mx-auto">
        <div class="flex items-center">
            <button class="text-gray-900 bg-white focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm p-2.5 mr-2 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-700" type="button" data-drawer-target="drawer-navigation" data-drawer-toggle="drawer-navigation" aria-controls="drawer-navigation">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path>
                </svg>
            </button>
            <span class="self-center text-sm sm:text-xl font-semibold whitespace-nowrap text-gray-900 dark:text-gray-400">Dashboard</span>
        </div>
            ...
            <ul class="space-y-2">
                ...
                <li>
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        <li>
                            <a href="/stockin" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Stock In</a>
                        </li>
                        <li>
                            <a href="/stockout" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Stock Out</a>
                        </li>
                    </ul>
                </li>
            </ul>

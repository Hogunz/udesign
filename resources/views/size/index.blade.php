            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="py-4 px-6">
                            {{ $size->created_at->format('F d, Y H:i:s') }}
                        </td>
                        <td class="flex flex-row gap-2 py-4 ">
                            @if(!$size->trashed())
                            <a href="{{ route('size.edit', $size->id) }}" class="href">
                            ...
                            @else
                            <a href="{{ route('size.restore', $size->id) }}">Restore</a>
                            @endif
                        </td>
                    </tr>
                    @endforeach
                </tbody>
                <a href="{{ route('size.create') }}" class="href">
